...
int main()
{
    ...
    save_rmse_to_json( average_result.rmse_list_tracking,"rmse_based_frame_tracking_0_035_6.json", LATENCY);
    save_rmse_to_json( average_result.rmse_list_det_succ,"rmse_based_frame_det_succ_0_035_6.json", LATENCY);
    save_rmse_to_json( average_result.rmse_list_det_fail,"rmse_based_frame_det_fail_0_035_6.json", LATENCY);
    return 0;
}
